...
final class MainViewController: BaseViewController {
  ...
  let collectionView = MainViewCollectionView().then {
    $0.register(PopularMeetingCell.self, forCellWithReuseIdentifier: "popularMeetingCell")
    $0.register(NewMeetingCell.self, forCellWithReuseIdentifier: "newMeetingCell")
  }
